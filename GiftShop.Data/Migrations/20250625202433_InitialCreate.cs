        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true, computedColumnSql: "[Quantity] * [UnitPrice]", stored: true),
                    OrderID = table.Column<int>(type: "int", nullable: false),
                    ProductID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                table: "AppUsers",
                columns: new[] { "AppUserID", "Email", "Name", "Password", "Phone", "Surname", "UserName" },
                values: new object[] { 1, "admineticaret@gmail.com", "Test", "123", "1234567890", "User", "Admin" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "CategoryID", "Description", "IsActive", "Name" },
                values: new object[] { 1, null, false, "Çiçekler" });
